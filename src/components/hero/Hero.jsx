...
const Hero = () => {
  ...
  return (
    <section className="hero bg-blue-100" style={divStyle}>
      <div className="max-w-6xl mx-auto md:mt-0 px-4 sm:px-6 md:px-8 justify-center items-center flex md:justify-between md:items-center h-full flex-col md:flex-row">
        <div className="md:w-1/2">
          ...
          <img src={herobg} alt="" className="md:w-1/2 md:h-auto w-full" />
