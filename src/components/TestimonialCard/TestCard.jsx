  ...
  return(
   ...
   <div className="py-12 w-3/4">
    ...
    <div className='bg-blue-500 border w-16 h-16 rounded-full text-center absolute -top-10 left-36'>  <p className='text-7xl mt-2 text-white'> “ </p></div>
        <p>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Possimus ratione et, consequuntur deleniti perspiciatis vel distinctio temporibus deserunt unde soluta!
        </p>
